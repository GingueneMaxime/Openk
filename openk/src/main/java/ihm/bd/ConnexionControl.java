...
public class ConnexionControl {
		 ...
		 */
		public void setMainApp(ConnexionGUI mainApp) {
			//System.out.println("setMainApp called");
			this.mainApp = mainApp;
			utilisateurTable.setItems(this.mainApp.getConnexionData());
		...
		private void afficheUtilisateurSelection() {
			...
			Mdp.setText(projetCourant.getMotDePasse());
			
		}

		@FXML
		public void handleButtonsListUtilisateur(ActionEvent event) {
			utilisateurTable.setItems(this.mainApp.getConnexionDataConnexion());
			afficheUtilisateurSelection(); 
		}
