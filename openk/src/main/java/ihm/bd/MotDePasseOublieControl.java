...
public class MotDePasseOublieControl {
		...
		private MotDePasseOublieGUI mainApp;
		 ...
		 */
		public MotDePasseOublieControl() {  	
		}
		 ...
		 */
		public void setMainApp(MotDePasseOublieGUI mainApp) {
			//System.out.println("setMainApp called");
			this.mainApp = mainApp;
			utilisateurTable.setItems(this.mainApp.getMotDePasseOublieData());
		...
		public void handleButtonsListUtilisateur(ActionEvent event) {
			utilisateurTable.setItems(this.mainApp.getMotDePasseOublieDataMotDePasseOublie());
			afficheUtilisateurSelection(); 
		}
